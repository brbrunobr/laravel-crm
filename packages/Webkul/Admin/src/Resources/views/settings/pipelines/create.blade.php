                            ...
                            <div class="flex min-w-[275px] max-w-[275px] flex-col justify-between rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
                                ...
                                <div class="flex flex-col gap-6 px-4 py-3">
                                    ...
                                    <div>
                                        ...
                                        {!! view_render_event('admin.settings.pipelines.create.form.stages.stage_type.before') !!}

                                        <!-- Stage Type Flags -->
                                        <div class="mb-4" v-if="isDragable(element)">
                                            <x-admin::form.control-group.label>
                                        ...
                                        {!! view_render_event('admin.settings.pipelines.create.form.stages.stage_type.after') !!}
                                    </div>
                                </div>
