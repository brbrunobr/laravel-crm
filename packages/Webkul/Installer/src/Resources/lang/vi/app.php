    ...
    'installer' => [
        'index' => [
            ...
            'installation-completed' => [
                ...
                'krayin-forums'              => 'Fórum do Delta Ai',
                'customer-panel'             => 'Painel do Cliente',
                'explore-krayin-extensions'  => 'Explorar Extensões do Delta Ai',
                'title'                      => 'Instalação Concluída',
                'title-info'                 => 'O Delta Ai foi instalado com sucesso no seu sistema.',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => 'Criar as tabelas do banco de dados',
                'install'                 => 'Instalar',
                'install-info'            => 'Delta Ai para Instalação',
            ...
            'continue'                 => 'Continuar',
            'installation-description' => 'A instalação do Delta Ai geralmente envolve várias etapas. Aqui está um resumo do processo de instalação do Delta Ai.',
